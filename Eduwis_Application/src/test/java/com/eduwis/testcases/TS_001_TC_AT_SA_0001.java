...
public class TS_001_TC_AT_SA_0001 extends Base_class {
	...
	public void ClassDropdownValidation() {
		...
		SAssert.assertFalse(sa.errormsg_class.isDisplayed());
	...
	public void StudentAttendance_Searching() {
	...
	public void HolidayMarking()  {
		...
		// Assert.assertEquals(bp.ActualConfirmationMsg, bp.ExpectedConfirmationMsg,"No
		// popup displayed");
		bp.DismissPopup();
